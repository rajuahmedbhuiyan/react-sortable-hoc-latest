...
# [2.0.2](https://github.com/rajuahmedbhuiyan/react-sortable-hoc-latest/compare/v2.0.1...v2.0.2) (2025-01-14)

### Changed
- Updated CodeSandbox integration link to use new GitHub repository
- Updated LICENSE file to include new author information
- Updated CHANGELOG with new version information

<a name="2.0.1"></a>

# [2.0.1](https://github.com/rajuahmedbhuiyan/react-sortable-hoc-latest/compare/v2.0.0...v2.0.1) (2025-01-14)

### Changed
- Updated repository URLs to point to new GitHub repository
- Updated author information to Raju Ahmed Bhuiyan
- Updated all documentation links and badges
